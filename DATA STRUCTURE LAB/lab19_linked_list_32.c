// Project	Program for addition very long numbers using Linked List
...
int main()
{
    ...
    printf("\n\n\n");
    // input 4 numbers (as 2 bit interger) in one linked list to reduce the cycles
    // can store the number in the form of string to take the input and then convert it into linked list
    addition_of_LL(&start1,&start2,&start3);
    printf("ADDITION OF VERY LARGE NUMBER USING LINKED LIST:");
    display(start3);
